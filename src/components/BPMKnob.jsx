...
export function BPMKnob({ value, min = 20, max = 320, onChange, T }) {
  ...
  return (
    <div className="flex flex-col items-center gap-1 select-none">
      ...
      <span style={{ color: T.accent, fontSize: 24, fontFamily: "monospace", fontWeight: 700, lineHeight: 1 }}>{value}</span>
